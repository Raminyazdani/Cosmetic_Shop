# Generated by Django 4.1.4 on 2023-01-12 10:15
...
import Core.fields.ForeignKey
import Core.fields.IdFields
import Core.fields.ManyToManyFields
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', Core.fields.DateFields.CreatedAt(auto_now_add=True, help_text='When this Model record was created', null=True, verbose_name='Created At')),
                ('modified_at', Core.fields.DateFields.ModifiedAt(auto_now=True, help_text='When this Model record was modified', null=True, verbose_name='Modified At')),
                ('product_id', Core.fields.ForeignKey.ForeignKeyProduct(blank=True, help_text='Product of this Tag record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='producttags', to='Products.product', verbose_name='Tag`s Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', Core.fields.ManyToManyFields.ManyToManyProduct(blank=True, db_index=True, help_text='Product of this Tag record', related_name='tag_product', through='Products.ProductTag', to='Products.product', verbose_name='Tag`s Product')),
            ],
            options={
                'verbose_name': 'Tag',
        ...
        migrations.AddField(
            ...
            name='tag_id',
            field=Core.fields.ForeignKey.ForeignKeyTag(blank=True, help_text='Product of this Tag record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='producttags', to='Products.tag', verbose_name='Tag`s Product'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', Core.fields.DateFields.CreatedAt(auto_now_add=True, help_text='When this Model record was created', null=True, verbose_name='Created At')),
                ('modified_at', Core.fields.DateFields.ModifiedAt(auto_now=True, help_text='When this Model record was modified', null=True, verbose_name='Modified At')),
                ('category_id', Core.fields.ForeignKey.ForeignKeyCategory(blank=True, help_text='Product of this Category record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='productcategorys', to='Products.category', verbose_name='Category`s Product')),
                ('product_id', Core.fields.ForeignKey.ForeignKeyProduct(blank=True, help_text='Product of this Category record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='productcategorys', to='Products.product', verbose_name='Category`s Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', Core.fields.DateFields.CreatedAt(auto_now_add=True, help_text='When this Model record was created', null=True, verbose_name='Created At')),
                ('modified_at', Core.fields.DateFields.ModifiedAt(auto_now=True, help_text='When this Model record was modified', null=True, verbose_name='Modified At')),
                ('brand_id', Core.fields.ForeignKey.ForeignKeyBrand(blank=True, help_text='Product of this Brand record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='productbrands', to='Products.brand', verbose_name='Brand`s Product')),
                ('product_id', Core.fields.ForeignKey.ForeignKeyProduct(blank=True, help_text='Product of this Brand record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='productbrands', to='Products.product', verbose_name='Brand`s Product')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='brand',
            field=Core.fields.ManyToManyFields.ManyToManyBrand(blank=True, db_index=True, help_text='Brand of this Product record', related_name='product_brand', through='Products.ProductBrand', to='Products.brand', verbose_name='Product`s Brand'),
        ),
        migrations.AddField(
            model_name='product',
            name='category',
            field=Core.fields.ManyToManyFields.ManyToManyCategory(blank=True, db_index=True, help_text='Category of this Product record', related_name='product_category', through='Products.ProductCategory', to='Products.category', verbose_name='Product`s Category'),
        ),
        migrations.AddField(
            model_name='product',
            name='comment',
            field=Core.fields.ForeignKey.ForeignKeyComment(blank=True, help_text='Comment of this Product record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products', to='Products.comment', verbose_name='Product`s Comment'),
        ),
        migrations.AddField(
            model_name='product',
            name='tag',
            field=Core.fields.ManyToManyFields.ManyToManyTag(blank=True, db_index=True, help_text='Tag of this Product record', related_name='product_tag', through='Products.ProductTag', to='Products.tag', verbose_name='Product`s Tag'),
        ),
    ]
