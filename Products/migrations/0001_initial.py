...
import Core.ProjectMixins.Products
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(Core.ProjectMixins.Products.ModelRequiredProperties.Brand, models.Model),
        ),
        migrations.CreateModel(
            name='Category',
            fields=[
            ...
            bases=(Core.ProjectMixins.Products.ModelRequiredProperties.Category, models.Model),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
            ...
            bases=(Core.ProjectMixins.Products.ModelRequiredProperties.Comment, models.Model),
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('price', Core.fields.DecimalFields.CustomPriceFieldDollar(db_index=True, decimal_places=2, default=0.0, help_text='Dollar Price of this Product record', max_digits=10, validators=[django.core.validators.MinValueValidator(0, message='Price must be at least 0'), django.core.validators.MaxValueValidator(1000000000, message='Price must be at most 1000000000')], verbose_name='Product`s Dollar Price')),
            ...
            bases=(Core.ProjectMixins.Products.ModelRequiredProperties.Product, models.Model),
        ),
        migrations.CreateModel(
            name='ProductTag',
            fields=[
                ('id', Core.fields.IdFields.CustomIdField(db_index=True, help_text='Id of this Model record', primary_key=True, serialize=False, verbose_name='Model`s Id')),
                ('product_id', Core.fields.ForeignKeys.CustomProductFieldForeignKey(blank=True, help_text='Product of this Tag record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='producttag_product', to='Products.product', verbose_name='Tag`s Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            bases=(Core.ProjectMixins.Products.ModelRequiredProperties.Tag, models.Model),
        ),
        migrations.AddField(
            model_name='producttag',
            name='tag_id',
            field=Core.fields.ForeignKeys.CustomTagFieldForeignKey(blank=True, help_text='Product of this Tag record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='producttag_tag', to='Products.tag', verbose_name='Tag`s Product'),
        ),
        migrations.CreateModel(
            name='ProductCategory',
            fields=[
                ('id', Core.fields.IdFields.CustomIdField(db_index=True, help_text='Id of this Model record', primary_key=True, serialize=False, verbose_name='Model`s Id')),
                ('category_id', Core.fields.ForeignKeys.CustomCategoryFieldForeignKey(blank=True, help_text='Product of this Category record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='productcategory_category', to='Products.category', verbose_name='Category`s Product')),
                ('product_id', Core.fields.ForeignKeys.CustomProductFieldForeignKey(blank=True, help_text='Product of this Category record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='productcategory_product', to='Products.product', verbose_name='Category`s Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', Core.fields.IdFields.CustomIdField(db_index=True, help_text='Id of this Model record', primary_key=True, serialize=False, verbose_name='Model`s Id')),
                ('brand_id', Core.fields.ForeignKeys.CustomBrandFieldForeignKey(blank=True, help_text='Product of this Brand record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='productbrand_brand', to='Products.brand', verbose_name='Brand`s Product')),
                ('product_id', Core.fields.ForeignKeys.CustomProductFieldForeignKey(blank=True, help_text='Product of this Brand record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='productbrand_product', to='Products.product', verbose_name='Brand`s Product')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='comment',
            field=Core.fields.ForeignKeys.CustomCommentFieldForeignKey(blank=True, help_text='Comment of this Product record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='product_comment', to='Products.comment', verbose_name='Product`s Comment'),
        ),
        migrations.AddField(
            model_name='product',
            name='tag',
