...
>>>>>>> Stashed changes
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='product',
<<<<<<< Updated upstream
            field=Core.fields.ForeignKeys.CustomProductFieldForeignKey(blank=True, help_text='Product of this Comment record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='comment_product', to='Products.product', verbose_name='Comment`s Product'),
=======
