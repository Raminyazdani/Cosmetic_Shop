...
class WalletGenericRelation(DefaultFields.GenericRelations):
    ...
    "app_name_model_destination": "Wallet",
    }
    
    def __init__(self, *args, **kwargs):
        deleters = []
        class_attrs = WalletGenericRelation.class_custom_default_attrs
