...
class PaymentGenericRelation(DefaultFields.GenericRelations):
    ...
    "app_name_model_destination": "Payment",
    }
    
    def __init__(self, *args, **kwargs):
        deleters = []
        class_attrs = PaymentGenericRelation.class_custom_default_attrs
