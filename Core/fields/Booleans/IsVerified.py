...
class IsVerified(DefaultFields.Booleans):
    ...
    def __init__(self, *args, **kwargs):
        deleters = []
        class_attrs = IsVerified.class_custom_default_attrs
        ...
        kwargs["verbose_name"] = kwargs.get("verbose_name", _("Verified"))
