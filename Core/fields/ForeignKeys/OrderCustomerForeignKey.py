...
class OrderCustomerForeignKey(DefaultFields.ForeignKeys):
    ...
    "class_name": "Model",
    "field_name": "OrderCustomer",
    "app_name_destination": "Customers",
    "app_name_model_destination": "OrderCustomer",
    }
    
    def __init__(self, *args, **kwargs):
        deleters = []
        class_attrs = OrderCustomerForeignKey.class_custom_default_attrs
