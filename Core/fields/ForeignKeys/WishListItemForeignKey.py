...
class WishListItemForeignKey(DefaultFields.ForeignKeys):
    ...
    "class_name": "Model",
    "field_name": "WishListItem",
    "app_name_destination": "Customers",
    "app_name_model_destination": "WishListItem",
    }
    
    def __init__(self, *args, **kwargs):
        deleters = []
        class_attrs = WishListItemForeignKey.class_custom_default_attrs
