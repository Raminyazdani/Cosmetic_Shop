...
class PropertyItemForeignKey(DefaultFields.ForeignKeys):
    ...
    "class_name": "Model",
    "field_name": "PropertyItem",
    "app_name_destination": "Markets",
    "app_name_model_destination": "PropertyItem",
    }
    
    def __init__(self, *args, **kwargs):
        deleters = []
        class_attrs = PropertyItemForeignKey.class_custom_default_attrs
