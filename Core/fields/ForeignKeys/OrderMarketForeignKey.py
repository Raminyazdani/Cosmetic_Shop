...
class OrderMarketForeignKey(DefaultFields.ForeignKeys):
    ...
    "class_name": "Model",
    "field_name": "OrderMarket",
    "app_name_destination": "Markets",
    "app_name_model_destination": "OrderMarket",
    }
    
    def __init__(self, *args, **kwargs):
        deleters = []
        class_attrs = OrderMarketForeignKey.class_custom_default_attrs
