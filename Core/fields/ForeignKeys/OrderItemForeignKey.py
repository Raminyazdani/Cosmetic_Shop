...
class OrderItemForeignKey(DefaultFields.ForeignKeys):
    ...
    "class_name": "Model",
    "field_name": "OrderItem",
    "app_name_destination": "Shops",
    "app_name_model_destination": "OrderItem",
    }
    
    def __init__(self, *args, **kwargs):
        deleters = []
        class_attrs = OrderItemForeignKey.class_custom_default_attrs
